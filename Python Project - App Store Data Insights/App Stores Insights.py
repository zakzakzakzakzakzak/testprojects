...
## the above cells take the frequency couint for genre on the appstore, and also the total installs per genre category, to average the amount of installs per category as a way to determine likeliest app genre to be popular
